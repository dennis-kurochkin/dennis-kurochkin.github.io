...
class LiteYTEmbed extends HTMLElement{constructor(){super(),this.videoId=encodeURIComponent(this.getAttribute("videoid")),this.rel=encodeURIComponent(this.getAttribute("rel")),this.posterUrl=`https://i.ytimg.com/vi/${this.videoId}/hqdefault.jpg`,LiteYTEmbed.addPrefetch("preload",this.posterUrl,"image")}connectedCallback(){this.style.backgroundImage=`url("${this.posterUrl}")`;const e=document.createElement("div");e.classList.add("lty-playbtn"),this.append(e),this.addEventListener("pointerover",LiteYTEmbed.warmConnections,{once:!0}),this.addEventListener("click",e=>this.addIframe())}static addPrefetch(e,t,d){const i=document.createElement("link");i.rel=e,i.href=t,d&&(i.as=d),i.crossorigin=!0,document.head.append(i)}static warmConnections(){LiteYTEmbed.preconnected||(LiteYTEmbed.addPrefetch("preconnect","https://www.youtube.com"),LiteYTEmbed.addPrefetch("preconnect","https://www.google.com"),LiteYTEmbed.addPrefetch("preconnect","https://googleads.g.doubleclick.net"),LiteYTEmbed.addPrefetch("preconnect","https://static.doubleclick.net"),LiteYTEmbed.preconnected=!0)}addIframe(){let e=`${this.videoId}?autoplay=1`;this.rel&&"null"!==this.rel&&(e+=`&rel=${this.rel}`);const t=`\n<iframe width="560" height="315" frameborder="0"\n  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen\n  src="https://www.youtube.com/embed/${e}"\n></iframe>`;this.insertAdjacentHTML("beforeend",t),this.classList.add("lyt-activated")}}customElements.define("lite-youtube",LiteYTEmbed);
var quiz={init:function(){console.log("Quiz initiated!")}};
$(function(){var s=$("body").data("sprite");svg4everybody(),$(".js-open-popup-link").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom",closeMarkup:'<button title="Закрыть (ESC)" type="button" class="mfp-close cmn-popup__close-btn">×</button>'}),$(".js-open-image-link").magnificPopup({type:"image",fixedContentPos:!1,fixedBgPos:!0,mainClass:"mfp-img-mobile",image:{verticalFit:!0}}),$(".js-reviews-slider").slick({slidesToShow:3,rows:0,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1,prevArrow:'<button type="button" class="slick-prev btn-slick-arrow"><svg class="icon-svg"><use xlink:href="'+s+'#9"></use></svg></button>',nextArrow:'<button type="button" class="slick-next btn-slick-arrow"><svg class="icon-svg"><use xlink:href="'+s+'#10"></use></svg></button>',responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:400,settings:{slidesToShow:1}}]}),$(".js-choosing-us-slider").slick({slidesToShow:3,rows:0,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1,prevArrow:'<button type="button" class="slick-prev btn-slick-arrow btn-slick-arrow--alt"><svg class="icon-svg"><use xlink:href="'+s+'#9"></use></svg></button>',nextArrow:'<button type="button" class="slick-next btn-slick-arrow btn-slick-arrow--alt"><svg class="icon-svg"><use xlink:href="'+s+'#10"></use></svg></button>',responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:400,settings:{slidesToShow:1}}]}),$(".js-product-slider").slick({slidesToShow:3,rows:0,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1,prevArrow:'<button type="button" class="slick-prev btn-slick-arrow"><svg class="icon-svg"><use xlink:href="'+s+'#9"></use></svg></button>',nextArrow:'<button type="button" class="slick-next btn-slick-arrow"><svg class="icon-svg"><use xlink:href="'+s+'#10"></use></svg></button>',responsive:[{breakpoint:950,settings:{slidesToShow:2}},{breakpoint:500,settings:{slidesToShow:1}}]}),$(".js-product-main-slider").slick({slidesToShow:1,rows:0,arrows:!1,dots:!1,asNavFor:".js-product-control-slider"}),$(".js-product-control-slider").slick({slidesToShow:3,rows:0,arrows:!1,dots:!1,draggable:!1,asNavFor:".js-product-main-slider"}),$(".js-product-control-slide").click(function(){$(".js-product-main-slider").slick("slickGoTo",$(this).data("slick-index"))}),$(document).on("click","a.js-anchor-link",function(s){s.preventDefault(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},700)}),$(".js-mobile-nav-toggle").click(function(){$(".js-mobile-nav").addClass("active")}),$(".js-mobile-nav-wrapper, .js-mobile-nav-close").click(function(){$(".js-mobile-nav").removeClass("active")}),$(".js-toggle-active").click(function(){$(this).toggleClass("active")}),$(".js-form-quantity-input").keyup(function(){this.value=this.value.replace(/[^0-9]|^0+(?!$)/g,"")}),$(".js-form-quantity-input").on("focus click",function(){$(this).select()}),$(".js-form-quantity-add").click(function(){var s=$(this).parent().find($(".js-form-quantity-input")),t=parseInt(s.val());s.val(++t)}),$(".js-form-quantity-subtract").click(function(){var s=$(this).parent().find($(".js-form-quantity-input")),t=parseInt(s.val());s.val(--t)}),quiz.init()});