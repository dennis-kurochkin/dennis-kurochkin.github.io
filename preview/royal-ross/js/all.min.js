...
$(function(){$("body").data("sprite");svg4everybody(),$(".js-open-popup-link").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom",closeMarkup:'<button title="Закрыть (ESC)" type="button" class="mfp-close popup__btn-close">×</button>'}),$(".js-hero-slider").slick({slidesToShow:2,autoplay:!0,autoplaySpeed:3e3,arrows:!0,prevArrow:'<button type="button" class="slick-prev btn-slick hero__slider-btn"><svg class="icon-svg"><use xlink:href="images/sprite.svg#19"></use></svg></button>',nextArrow:'<button type="button" class="slick-next btn-slick hero__slider-btn"><svg class="icon-svg"><use xlink:href="images/sprite.svg#20"></use></svg></button>',dots:!1,rows:0,responsive:[{breakpoint:500,settings:{slidesToShow:1}}]}),$(".js-room-slider").slick({slidesToShow:1,autoplay:!0,autoplaySpeed:3e3,arrows:!0,prevArrow:'<button type="button" class="slick-prev btn-slick room__slider-btn"><svg class="icon-svg"><use xlink:href="images/sprite.svg#19"></use></svg></button>',nextArrow:'<button type="button" class="slick-next btn-slick room__slider-btn"><svg class="icon-svg"><use xlink:href="images/sprite.svg#20"></use></svg></button>',dots:!1,rows:0,responsive:[{breakpoint:500,settings:{slidesToShow:1}}]}),$(".js-totop-btn").on("click",function(e){e.preventDefault(),$("html, body").animate({scrollTop:0},"500")}),$(".js-header-nav-toggle").click(function(){$(this).toggleClass("active"),$(".js-header-nav").toggleClass("active")}),$(document).on("click","a.js-anchor-link",function(e){e.preventDefault(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},700)}),$(".form__popup").submit(function(){var e=$(this);return afterTxt=$(e).find(".success"),$.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(afterTxt).addClass("form__success_visible"),setTimeout(function(){e.trigger("reset"),$(afterTxt).removeClass("form__success_visible"),$.magnificPopup.close()},3e3)}),!1}),$("input.js-date-range-picker").daterangepicker({autoUpdateInput:!0,minDate:moment().format("DD.MM.YYYY"),locale:{format:"DD.MM.YYYY",separator:" - ",applyLabel:"Применить",cancelLabel:"Отмена",fromLabel:"С",toLabel:"До",weekLabel:"Нед",daysOfWeek:["Пн","Вт","Ср","Чт","Пт","Сб","Вс"],monthNames:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"]},isCustomDate:function(e){if(e.format("DD.MM.YYYY")===moment().format("DD.MM.YYYY"))return"booked"}}),$("input.js-date-range-picker").on("apply.daterangepicker",function(e,t){$(this).val(t.startDate.format("DD.MM.YYYY")+" - "+t.endDate.format("DD.MM.YYYY"))}),$("input.js-date-range-picker").on("cancel.daterangepicker",function(e,t){$(this).val("")})});