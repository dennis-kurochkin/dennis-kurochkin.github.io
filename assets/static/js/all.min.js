...
$(function(){$("body").data("sprite");svg4everybody(),$(".js-open-popup-link").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom",closeMarkup:'<button title="Закрыть (ESC)" type="button" class="mfp-close popup__close-btn">×</button>'}),$(".js-slider").slick({slidesToShow:3,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1,appendArrows:$(".js-slider-nav"),prevArrow:'<button type="button" class="slick-prev"><svg class="icon-svg icon-14"><use xlink:href="images/sprite.svg#14"></use></svg></button>',nextArrow:'<button type="button" class="slick-next"><svg class="icon-svg icon-13"><use xlink:href="images/sprite.svg#13"></use></svg></button>',responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:575,settings:{slidesToShow:1}}]}),$(".js-totop-btn").on("click",function(e){e.preventDefault(),$("html, body").animate({scrollTop:0},"500")}),$(".js-header-hamburger").click(function(){$("body").addClass("overflow-hidden"),$(".js-overlay").addClass("overlay-active"),$(".js-layout").addClass("mobile-menu-active"),$(".js-mobile-menu").addClass("active")}),$(".js-mobile-menu-close").click(function(){$("body").removeClass("overflow-hidden"),$(".js-overlay").removeClass("overlay-active"),$(".js-layout").removeClass("mobile-menu-active"),$(".js-mobile-menu").removeClass("active")}),$(".js-overlay").click(function(e){$(e.target).hasClass("js-overlay")&&($("body").removeClass("overflow-hidden"),$(".js-overlay").removeClass("overlay-active"),$(".js-layout").removeClass("mobile-menu-active"),$(".js-mobile-menu").removeClass("active"))}),$(document).on("click","a.js-anchor-link",function(e){e.preventDefault(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},700)}),$(".form__popup").submit(function(){var e=$(this);return afterTxt=$(e).find(".success"),$.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(afterTxt).addClass("form__success_visible"),setTimeout(function(){e.trigger("reset"),$(afterTxt).removeClass("form__success_visible"),$.magnificPopup.close()},3e3)}),!1})});